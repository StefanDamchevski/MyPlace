...
namespace MyPlace
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<MyPlaceDbContext>(options => options.UseSqlServer(Configuration.GetConnectionString("MyPlaceDb")));
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseMvc(routes =>
            {
                routes.MapRoute(
                    name: "default",
                    template: "{controller=Image}/{action=Overview}/{id?}");
            });
        }
    }
}
